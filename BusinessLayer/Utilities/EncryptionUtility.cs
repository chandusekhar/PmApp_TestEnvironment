...
namespace BusinessLayer.Utilities
{
    public static class EncryptionUtility
    {
        ...
        private static string _salt = "y^%09j(*&^FGV.<K"; // Random
        private static string _vector = "n%^&(*hy^&2$#X5V"; // Random

        private static string Key = "!@#$%^(*&YGFASFDGHQ&*^@#*&FHBCNBAKLJEOIQ*(&*^&%654652637824871hsdjbdh";
        #endregion
